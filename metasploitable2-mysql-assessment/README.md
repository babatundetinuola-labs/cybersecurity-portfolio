...
#Objective
 To assess the security of an intentionally vulnerable metasploitable2 system by identifying exposed services,investigating the mysql service, and assesing the security of password storage within the DVWA application.
